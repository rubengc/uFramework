...
class Cmb2_Metatabs_Options {
	...
	public function add_css( $id ) {
		...
		$css .= '.cmo-options-page #poststuff h2.nav-tab-wrapper{padding-bottom:0;margin-bottom: 20px;}';
		$css .= '.cmo-options-page .opt-hidden{display:none;}';
		$css .= '.cmo-options-page #side-sortables{padding-top:22px;}';
		$css .= '</style>';
